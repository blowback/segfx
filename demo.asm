...
demo_stream
		...
		PAGE	TRANS_VFADE_D, DISP_SCROLL_L, TRANS_VFADE_U, STD_SPEED, 200, "Standalone Z80 kit computer, running CP/M"
		PAGE	TRANS_VFADE_U, DISP_SCROLL_L, TRANS_VFADE_D, STD_SPEED, 200, "24 character, 14 segment display + virtual console"
		PAGE	TRANS_NONE, DISP_TYPEWRITER, TRANS_NONE, STD_SPEED, 200, <INL_ALIGN_C, "47-key keyboard">
		PAGE	TRANS_WIPE_L, DISP_SCROLL_L, TRANS_WIPE_L, STD_SPEED, 300, "Z80 CPU 8-10MHz  /  512K RAM  /  512k Flash ROM"
		...
		PAGE	TRANS_NONE, DISP_MARQUEE_R, TRANS_NONE, STD_SPEED, 200, <INL_ALIGN_C, INL_BRIGHT, INL_PARAM_BASE + 15, "VideoBeast ", INL_BRIGHT, INL_PARAM_BASE + 10, " ready">
